...
This repository is intended to support **arm templating, deployment validation, network design, availability thinking and change-safe rollout**. The examples are deliberately conservative and should be adapted to the target environment.
