...
## Preamble on Azure Subscriptions

(Nov 2022) Microsoft [constantly reduces](https://learn.microsoft.com/en-us/azure/virtual-network/troubleshoot-outbound-smtp-connectivity) options to deploy e-mail sending systems in Azure. As of today, its only possible to deploy SMTP Port 25 sending appliances in **Azure Enterprise Subscriptions**. Please check your Azure Subscription and follow the instructions on the link above before deploying your SEPPmail Appliance in Azure.
