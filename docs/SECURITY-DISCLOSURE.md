...
Use this process for vulnerabilities, secrets exposure, unsafe defaults, privilege escalation paths, insecure examples or supply-chain concerns identified in **Seppmail-IaC-azure-nlb-cluster**.
