...
## Purpose
This document deepens the repository-specific architecture story for **Seppmail-IaC-azure-nlb-cluster**.

## Core focus
ARM and PowerShell based Azure load balancer cluster patterns for SEPPmail
